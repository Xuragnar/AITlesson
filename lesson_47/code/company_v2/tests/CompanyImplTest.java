package company_v2.tests;


import company_v2.dao.CompanyArrayListImpl;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import company_v2.dao.Company;
import company_v2.dao.CompanyImpl;
...
import static org.junit.jupiter.api.Assertions.*;
    ...
    class CompanyImplTest {
        ...
        void setUp() {
            ...
            e = new Employee[4];
            e[0] = new Manager(101, "John", "Smith", 45, 160, 5000, 5,15,"higher");
            e[1] = new SalesManager(102, "Anna", "Black", 36, 160, 25000, 0.1,7,"higher");
            e[2] = new SalesManager(103, "Thomas", "White", 28, 160, 30000, 0.1,10,"higher");
            e[3] = new Worker(104, "Gans", "Bauer", 30, 80, 5,4,"middle");
        ...
        void addEmployee() {
            ...
            Employee employee1 = new Manager(105, "Ivan", "Dubin", 55, 160, 6000, 6,6,"higher"); // создали нового сотрудника
            ...
            Employee employee2 = new Manager(106, "Peter", "Dubin", 55, 160, 6000, 6,3,"higher"); // создали нового сотрудника
        ...
        void totalSalaryTest() {
            assertEquals(11700.0, company.totalSalary(), 0.01);
        }

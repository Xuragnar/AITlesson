...
//            counter++;
//        }
//        System.out.println(Arrays09.toString(myArray));
//        System.out.println(Arrays09.toString(strings1));
//
//
//
...
//        int[] arraySubarray = Arrays09.copyOf(myArray2,4);
//        int[] copyOfArray = Arrays09.copyOf(myArray2, myArray2.length);
//        System.out.println(Arrays09.toString(arraySubarray));
//
//        int[] arraySubarray2 = Arrays09.copyOfRange(myArray2, 4, 7);
//        int[] arraySubarray3 = Arrays09.copyOfRange(myArray2, 4, 7);
//        int[] arraySubarray4 = Arrays09.copyOfRange(myArray2, 4, 100); // [17, 56, 101, 0, 145, 0, 0, 0, 0 ... 0] -> new int[100 - 4]
//        System.out.println("arraySubarray2 " + Arrays09.toString(arraySubarray2) );
//        System.out.println("arraySubarray3 " + Arrays09.toString(arraySubarray3));
//        System.out.println(arraySubarray4.length);
//
//        System.out.println(arraySubarray2 == arraySubarray3);
//        System.out.println(Arrays09.equals(arraySubarray2, arraySubarray3));
//
//
//        System.out.println("myArray2 " + Arrays09.toString(myArray2));
//        Arrays09.sort(myArray2, 2, 6);
//
//        System.out.println("myArray2 " + Arrays09.toString(myArray2));
//        Arrays09.sort(myArray2);
//        System.out.println("myArray2 " + Arrays09.toString(myArray2));
//
//        System.out.println("copyOfArray: " + Arrays09.toString(copyOfArray));
//
//
